...
#define _00_TAU0_CH3_NOISE_OFF                (0x00U) /* noise filter OFF */
#define _08_TAU0_CH3_NOISE_ON                 (0x08U) /* noise filter ON */
/* Enable/disable using noise filter of TI02 pin input signal (TNFEN02) */
#define _00_TAU0_CH2_NOISE_OFF                (0x00U) /* noise filter OFF */
#define _04_TAU0_CH2_NOISE_ON                 (0x04U) /* noise filter ON */
/* Enable/disable using noise filter of TI01 pin input signal (TNFEN01) */
#define _00_TAU0_CH1_NOISE_OFF                (0x00U) /* noise filter OFF */
#define _02_TAU0_CH1_NOISE_ON                 (0x02U) /* noise filter ON */
/* Enable/disable using noise filter of TI00 pin input signal (TNFEN00) */
#define _00_TAU0_CH0_NOISE_OFF                (0x00U) /* noise filter OFF */
#define _01_TAU0_CH0_NOISE_ON                 (0x01U) /* noise filter ON */

/*
    Noise Filter Enable Register 2 (NFEN2) 
*/
/* Enable/disable using noise filter of TI11 pin input signal (TNFEN11) */
#define _00_TAU1_CH1_NOISE_OFF                (0x00U) /* noise filter OFF */
#define _02_TAU1_CH1_NOISE_ON                 (0x02U) /* noise filter ON */
/* Enable/disable using noise filter of TI10 pin input signal (TNFEN10) */
#define _00_TAU1_CH0_NOISE_OFF                (0x00U) /* noise filter OFF */
#define _01_TAU1_CH0_NOISE_ON                 (0x01U) /* noise filter ON */
...
Macro definitions
***********************************************************************************************************************/
#define _C34F_TAU_TDR00_VALUE                 (0xC34FU) /* 16-bit timer data register 00 */
/* Clock divisor for TAU0 channel 0 */
#define TAU0_CHANNEL0_DIVISOR             (64U)     /* fCLK/2^6 */
