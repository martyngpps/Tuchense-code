...
*/
/* Section of operation clock (CKm0) (PRSm03,PRSm02,PRSm01,PRSm00,) */
...
/* Section of operation clock (CKm1) (PRSm13,PRSm12,PRSm11,PRSm10,) */
...
#define _00_SAU_TI03_USED                       (0x00U) /* Uses the input signal of the TI03 pin as a timer input */
#define _02_SAU_RXD0_USED                       (0x02U) /* Input signal of the RxD0 pin is used as timer input */
/* Switching external interrupt (INTP0) input (ISC0) */
#define _00_SAU_INTP0_USED                      (0x00U) /* Uses the input signal of the INTP0 pin as an external interrupt */
#define _01_SAU_RXD0_USED                       (0x01U) /* Uses the input signal of the RxD0 pin as an external interrupt */
...
Macro definitions
***********************************************************************************************************************/
#define _8800_SAU0_CH0_BAUDRATE_DIVISOR         (0x8800U) /* transfer clock set by dividing the operating clock */
...
#define _0808_SO0_DEFAULT_VALUE                 (0x0808U) /* SO0 default value */
